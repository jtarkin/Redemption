 ...
 ***************************************************************************/
 ...
 /***************************
 Avacar Helpful Comment Project
 
 Remember: flag_type is (name, bit, settable)
 
 Not sure what settable does, but *most* seem to be set to TRUE.  If someone figures it out, replace this with
 an explanation.
 
 Don't forget to also update the bit definitions in merc.h as most of them are aliased from their letter value to a human
 readable flag. 
 *****************************/
...
{
//usion look here for new dam names for earth, divine, shadow, wind flags
   {"hit", 0, TRUE},                /*  0 */
   {"slice", 1, TRUE},
   {"stab", 2, TRUE},
   {"slash", 3, TRUE},
...
const struct flag_type weapon_type2[] =
{
   ...
   {"wind", WEAPON_WIND, TRUE},
   {"earth", WEAPON_EARTH, TRUE},
   {"divine", WEAPON_DIVINE, TRUE},
   {"shadow", WEAPON_SHADOW, TRUE},
   {"none", 0, TRUE},
   {NULL, 0, 0}
};
...
const struct flag_type res_flags[] =
{
   ...
   {"divine", RES_DIVINE, TRUE},
   {"shadow", RES_SHADOW, TRUE},
...
const struct flag_type vuln_flags[] =
{
   ...
   {"divine", VULN_DIVINE, TRUE},
   {"shadow", VULN_SHADOW, TRUE},
   {NULL, 0, 0}
};
