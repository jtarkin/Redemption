...
// timers for effect_damage_pc handling, currently in rounds
#define TIMER_HEAT_METAL	8
#define	TIMER_SHRIEK		10
#define	TIMER_ATTRACTION	10
#define TIMER_DETONATE 		12

//# of rounds = pluse_tick / pulse_violence
...
DECLARE_SPELL_FUN(spell_divine_breath);
DECLARE_SPELL_FUN(spell_wind_breath);
DECLARE_SPELL_FUN(spell_water_breath);
DECLARE_SPELL_FUN(spell_earth_breath);
DECLARE_SPELL_FUN(spell_shadow_breath);

DECLARE_SPELL_FUN(spell_brilliance);
DECLARE_SPELL_FUN(spell_dominate);
DECLARE_SPELL_FUN(spell_aura_of_peace);
DECLARE_END_FUN(end_hibernate);

DECLARE_SPELL_FUN(spell_preserve);
DECLARE_SPELL_FUN(spell_imbue);
DECLARE_SPELL_FUN(spell_reduce);
DECLARE_END_FUN(end_reduce);
DECLARE_SPELL_FUN(spell_mystic_stone);
DECLARE_SPELL_FUN(spell_flameguard);
DECLARE_SPELL_FUN(spell_edge);
#endif
