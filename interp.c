...
const struct cmd_type cmd_table[] =
{
		...
		{"addgem", do_add_gemstone, POS_DEAD, 0, TRUE, LOG_NORMAL, 1, FALSE},
		{"addpart", do_addpart, POS_DEAD, 0, TRUE, LOG_NORMAL, 1, FALSE},
		...
		{"absorption", do_absorption, POS_FIGHTING, 0, TRUE, LOG_NORMAL, 1, TRUE},
		...
		{"autofollow", do_autofollow, POS_DEAD, 0, TRUE, LOG_NORMAL, 1, FALSE},
		...
		{"addrecruite", do_addrecruite, POS_STANDING, 52, TRUE, LOG_ALWAYS, 1, FALSE},
		{"addrecruiter", do_addrecruiter, POS_STANDING, 52, TRUE, LOG_ALWAYS, 1, FALSE},
		...
		{"barrage", do_barrage, POS_FIGHTING, 0, TRUE, LOG_NORMAL, 1, TRUE},
		{"bashdoor", do_bash_door, POS_FIGHTING, 0, TRUE, LOG_NORMAL, 1, TRUE},
		{"battleroar", do_battleroar, POS_FIGHTING, 0, TRUE, LOG_NORMAL, 1, TRUE},
		...
		{"bleeder", do_bleeder, POS_FIGHTING, 0, TRUE, LOG_NORMAL, 1, TRUE},
		{"burrow", do_burrow, POS_RESTING, 0, TRUE, LOG_NORMAL, 1, TRUE},
		...
		{"cedit", do_clanedit, POS_DEAD, L4, TRUE, LOG_ALWAYS, 1, FALSE},
		//{"circle", do_circle, POS_FIGHTING, 0, TRUE, LOG_NORMAL, 1, TRUE},
		{"channels", do_channels, POS_DEAD, 0, TRUE, LOG_NORMAL, 1, FALSE},
		{"chakra", do_chakra, POS_FIGHTING, 0, TRUE, LOG_NORMAL, 1, TRUE},
		{"challenge", do_challenge, POS_STANDING, 0, TRUE, LOG_NORMAL, 1, TRUE},
		...
		{"clanpolicy", do_clanpolicy, POS_SLEEPING, 0, TRUE, LOG_NORMAL, 1, TRUE},
		{"claninfo", do_claninfo, POS_SLEEPING, 0, TRUE, LOG_NORMAL, 1, TRUE},
		{"clanreport", do_clan_report, POS_SLEEPING, 0, TRUE, LOG_NORMAL, 1, TRUE},
        {"class", do_class_change, POS_RESTING, 0, TRUE, LOG_ALWAYS, 1, FALSE},
		...
		{"createring", do_create_ring, POS_STANDING, 0, FALSE, LOG_NORMAL, 1, FALSE},
		{"createstaff", do_create_staff, POS_STANDING, 0, FALSE, LOG_NORMAL, 1, FALSE},
		{"createwand", do_create_wand, POS_STANDING, 0, FALSE, LOG_NORMAL, 1, FALSE},
		{"createforge", do_create_forge, POS_STANDING, 0, FALSE, LOG_NORMAL, 1, FALSE},

		{"crash", do_crash, POS_SLEEPING, 60, FALSE, LOG_ALWAYS, 1, FALSE},
		{"colour", do_colour, POS_DEAD, 0, TRUE, LOG_NORMAL, 1, FALSE},
		{"cstring", do_cstring, POS_DEAD, L4, TRUE, LOG_ALWAYS, 1, FALSE},
		...
		{"clanedit", do_clanedit, POS_DEAD, L4, TRUE, LOG_ALWAYS, 1, FALSE},
		...
		{"delevel", do_delevel, POS_STANDING, 0, TRUE, LOG_NORMAL, TRUE},
		...
		{"destroymagic", do_destroy_magic, POS_STANDING, 0, TRUE, LOG_NORMAL, TRUE},
		...
		{"disassemble", do_disassemble, POS_STANDING, 0, TRUE, LOG_NORMAL, TRUE},
		{"drag", do_drag, POS_STANDING, 0, TRUE, LOG_NORMAL, 1, TRUE},
		{"dragon", do_dragon_kick, POS_FIGHTING, 0, TRUE, LOG_NORMAL, 1 ,TRUE},
		{"dragonchange", do_dragonchange, POS_STANDING, 0, TRUE, LOG_NORMAL, 1 ,TRUE},
		...
		{"disenchant", do_fuse_item, POS_STANDING, 0, TRUE, LOG_NORMAL, 1, TRUE},
		...
		{"double", do_double, POS_DEAD, L2, TRUE, LOG_ALWAYS, 1, FALSE},
		{"droprecruite", do_droprecruite, POS_STANDING, 52, TRUE, LOG_ALWAYS, 1, FALSE},
		{"droprecruiter", do_droprecruiter, POS_STANDING, 52, TRUE, LOG_ALWAYS, 1, FALSE},
		...
		{"geneqlist", do_geneqlist, POS_DEAD, 60, TRUE, LOG_NORMAL, 1, TRUE},
		...
		{"graft", do_graft, POS_RESTING, 0, TRUE, LOG_NORMAL, 1, TRUE},
		...
		{"goodbye", do_logoutgreet, POS_DEAD, L6, LOG_NORMAL, 1, FALSE},

		{"ruthless", do_hardcore, POS_DEAD, 0, TRUE, LOG_NORMAL, 1, FALSE},
		{"harden", do_harden, POS_FIGHTING, 0, TRUE, LOG_NORMAL, 1, TRUE},
		...
		{"hibernate", do_hibernate, POS_RESTING, 0, TRUE, LOG_NORMAL, 1, TRUE},
		{"hide", do_hide, POS_RESTING, 0, TRUE, LOG_NORMAL, 1, TRUE},
		{"hideout", do_hideout, POS_RESTING, 0, TRUE, LOG_NORMAL, 1, TRUE},
		...
		{"hunter hawk", do_hunter_hawk, POS_STANDING, 0, TRUE, LOG_NORMAL, 1, TRUE},
		{"hurl", do_hurl, POS_FIGHTING, 0, TRUE, LOG_NORMAL, 1, TRUE},
		{"harass", do_harass, POS_FIGHTING, 0, TRUE, LOG_NORMAL, 1, TRUE},		
		...
		{"incinerate", do_incinerate, POS_STANDING, 0, TRUE, LOG_NORMAL, 1, TRUE},
		{"inspect", do_inspect_shop, POS_RESTING, 0, TRUE, LOG_NORMAL, 1, TRUE},
		{"invis", do_invis, POS_DEAD, L6, TRUE, LOG_NORMAL, 0, FALSE},
		{"infuse", do_infuse, POS_STANDING, 0, TRUE, LOG_NORMAL, TRUE},
		...
		{"ironguard", do_iron_guard, POS_FIGHTING, 0, TRUE, LOG_NORMAL, 1, TRUE},
		...
		{"learn", do_learn, POS_RESTING, 0, TRUE, LOG_NORMAL, 1, TRUE},
		...
		{"makegolem", do_makegolem, POS_STANDING, 0, TRUE, LOG_NORMAL, TRUE},
		...
		{"mclone", do_mclone, POS_DEAD, L4, TRUE, LOG_ALWAYS, 1, FALSE},
		...
		{"nohints", do_nohints, POS_DEAD, 0, TRUE, LOG_NORMAL, 1, TRUE},
		...
		{"noop", do_noop, POS_SLEEPING, 0, FALSE, LOG_NEVER, 0, FALSE},
		{"nova", do_nova, POS_FIGHTING, 0, TRUE, LOG_NORMAL, 1, TRUE},
		...
		{"ninjutsu", do_ninjutsu, POS_FIGHTING, 0, TRUE, LOG_NORMAL, 1, TRUE},
		...
		{"oclone", do_oclone, POS_DEAD, L4, TRUE, LOG_ALWAYS, 1, FALSE},
		...
		{"ostring", do_ostring, POS_DEAD, L4, TRUE, LOG_ALWAYS, 1, FALSE},
		{"otimer", do_otimer, POS_DEAD, L4, TRUE, LOG_ALWAYS, 1, FALSE},
		...
		{"pindown", do_pindown, POS_FIGHTING, 0, TRUE, LOG_NORMAL, 1, TRUE},
		...
		{"pdouble", do_pdouble, POS_DEAD, L2, TRUE, LOG_ALWAYS, 1, FALSE},
		...
		{"powerlevel", do_powerlevel, POS_RESTING, L2, TRUE, LOG_NORMAL, 1, TRUE},
		...
		{"preserve", do_preserve, POS_RESTING, 0, TRUE, LOG_NORMAL, 1, TRUE},
		...
		{"punish", do_punish, POS_DEAD, L5, TRUE, LOG_ALWAYS, 1, FALSE},
		...
		{"roll", do_roll, POS_RESTING, 0, TRUE, LOG_NORMAL, 1, TRUE},
		...
		{"repair", do_repair_golem, POS_STANDING, 0, TRUE, LOG_NORMAL, TRUE},
		...
		{"rewhere", do_rewhere, POS_DEAD, L6, TRUE, LOG_NORMAL, 1, FALSE},
		...
		{"shoot", do_ranged_attack, POS_FIGHTING, 0, TRUE, LOG_NORMAL, 1, TRUE},
		...
		{"smite", do_smite, POS_FIGHTING, 0, TRUE, LOG_NORMAL, 1, TRUE},
		...
		{"shop", do_shopmain, POS_RESTING, 0, TRUE, LOG_NORMAL, 1, TRUE},
		...
		{"slide", do_slide, POS_FIGHTING, 0, TRUE, LOG_NORMAL, 1, TRUE},
		{"smokebomb", do_smokebomb, POS_FIGHTING, 0, TRUE, LOG_NORMAL, 1, TRUE },
		...
		{"setshop", do_set_player_shop, POS_DEAD, L2, TRUE, LOG_ALWAYS, 1, FALSE},
		{"setsliver", do_set_sliver_type, POS_DEAD, L2, TRUE, LOG_ALWAYS, 1, FALSE},
		...
		{"siege", do_siege, POS_STANDING, 0, FALSE, LOG_NORMAL, 0, FALSE},
		...
		{"swapleade", do_swapleade, POS_STANDING, 52, TRUE, LOG_ALWAYS, 1, FALSE},
		{"swapleader", do_swapleader, POS_STANDING, 52, TRUE, LOG_ALWAYS, 1, FALSE},
		...
		{"study", do_study, POS_DEAD, 0, TRUE, LOG_NORMAL, 1, FALSE},
		...
		{"timechange", do_timechange, POS_DEAD, L2, TRUE, LOG_ALWAYS, 1, FALSE},
		...
		{"toolbelt", do_toolbelt, POS_RESTING, 0, TRUE, LOG_NORMAL, 1, FALSE},
		{"toolget", do_toolget, POS_FIGHTING, 0, TRUE, LOG_NORMAL, 1, FALSE},
		...
		{"ungraft", do_ungraft, POS_RESTING, 0, TRUE, LOG_NORMAL, 1, TRUE},
		{"unalias", do_unalias, POS_DEAD, 0, TRUE, LOG_NORMAL, 1, FALSE},
		{"unhush", do_unhush, POS_DEAD, 0, TRUE, LOG_NORMAL, 1, FALSE},
		{"unclaim", do_unclaim, POS_STANDING, 0, TRUE, LOG_NORMAL, 1, FALSE},
		...
		{"vwhere", do_vwhere, POS_DEAD, L6, TRUE, LOG_NORMAL, 1, FALSE},
		...
		{"welcome", do_logingreet, POS_DEAD, L6, LOG_NORMAL, 1, FALSE},
		...
		{"wingblast", do_wingblast, POS_FIGHTING, 0, TRUE, LOG_NORMAL, 1, TRUE},
