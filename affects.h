 ...
 */
 ...
 /* Aql: Added caster to affect_data - it MUST be set to NULL for
 most room affect spells and to ch for room affect spells with a duration
 affect for hallow to work correctly. Irrelevant for non room affect spells
 at this time.*/
