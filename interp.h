...
#define L2	MAX_LEVEL - 2		/* diety */
#define L3	MAX_LEVEL - 3		/* god */
#define L4 	MAX_LEVEL - 4		/* demigod */
#define L5	MAX_LEVEL - 5		/* angel */
#define L6	MAX_LEVEL - 6		/* builder */
//These are not imms!
...
DECLARE_DO_FUN(do_class_change);
...
DECLARE_DO_FUN(do_logingreet);
DECLARE_DO_FUN(do_logoutgreet);
...
DECLARE_DO_FUN(do_battleroar);
DECLARE_DO_FUN(do_burrow);
DECLARE_DO_FUN(do_harden);
DECLARE_DO_FUN(do_hibernate);
DECLARE_DO_FUN(do_iron_guard);
DECLARE_DO_FUN(do_mindleech);
DECLARE_DO_FUN(do_nova);
DECLARE_DO_FUN(do_wingblast);
DECLARE_DO_FUN(do_smokebomb);
DECLARE_DO_FUN(do_hardcore);

DECLARE_DO_FUN(do_challenge);

DECLARE_DO_FUN(do_makegolem);
DECLARE_DO_FUN(do_addpart);
DECLARE_DO_FUN(do_destroy_magic);
DECLARE_DO_FUN(do_infuse);
DECLARE_DO_FUN(do_disassemble);
DECLARE_DO_FUN(do_repair_golem);

DECLARE_DO_FUN(do_create_ring);
DECLARE_DO_FUN(do_create_wand);
DECLARE_DO_FUN(do_create_staff);
DECLARE_DO_FUN(do_flux);
DECLARE_DO_FUN(do_fuse_item);
DECLARE_DO_FUN(do_learn);

DECLARE_DO_FUN(do_graft);
DECLARE_DO_FUN(do_ungraft);
DECLARE_DO_FUN(do_create_forge);
...
DECLARE_DO_FUN(do_toolbelt);
DECLARE_DO_FUN(do_toolget);

DECLARE_DO_FUN(do_shopmain);
DECLARE_DO_FUN(do_inspect_shop);
DECLARE_DO_FUN(do_add_gemstone);
DECLARE_DO_FUN(do_set_player_shop);
DECLARE_DO_FUN(do_set_sliver_type);
